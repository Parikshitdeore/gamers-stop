      ...
      <div className="form-container">
        ...
        <fieldset>
          ...
          <input
            ...
            placeholder="1501/B1,Tharwani Complex"
          ></input>
        </fieldset>
        ...
        <div className="modal-btns">
          <button
            onClick={() => {
              ...
              dispatch({
                type: update ? "UPDATE_ADDRESS" : "ADD_ADDRESS",
                payload: address,
              });
              toast.success(update ? "Address Updated" : "Address Added");
            }}
          >
            {update ? "Update" : "Add"}
          </button>
